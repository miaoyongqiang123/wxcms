...
<block name="content">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li class="active"><a href="{{u('store')}}" >文章添加</a></li>
    </ul>
    <!-- TAB CONTENT -->
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="author" placeholder="请输入文章作者">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="radio">
                            <label>
                                <input type="radio" name="is_recommened" value="1" >是
                            </label>
                            <label>
                                <input type="radio" name="is_recommened" value="2" checked>否
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group">
                            <input class="form-control" name="prev" readonly="" value="">
